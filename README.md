...
3. Wait until the API is enabled. Then, create a three-node cluster on GKE called **sofe4630u**. A Node is a worker machine in which docker images and applications can be deployed.
   ...
   ```cmd
   gcloud container clusters create sofe4630u   --num-nodes=3  --machine-type=e2-small   --disk-size=20 --zone=northamerica-northeast2-a 
   ```
...
### 1. Create an Integration Connectors to The MySQL Server
   ...
   4. Click **CREATE NEW CONNECTION**
      ...
      11. If your max number of nodes was not set correctly before, change the **Max Number of Nodes** to 2, scroll down, and click **Save**.  
...
## Acknowledgements
This repository is a fork of [zubxxr/SOFE4630U-MS2](https://github.com/zubxxr/SOFE4630U-MS2) , originally based on [GeorgeDaoud3/SOFE4630U-MS2](https://github.com/GeorgeDaoud3/SOFE4630U-MS2) . Credit to the original author(s) for the initial implementation.
